...
public class GroupLayer extends ChartLayer implements ChartView.IGroupLayer {
    ...
    public RectF prepareBeforeDraw(RectF rect) {
        ...
        RectF rightRectF = new RectF(leftRectF.right, rect.top, rect.right, rect.bottom);
        mRightLayer.prepareBeforeDraw(rightRectF);
    ...
    public ChartLayer getLayerByTag(String tag) {
        if (mLeftLayer instanceof ChartView.IGroupLayer) {
            ChartView.IGroupLayer layer = (ChartView.IGroupLayer) mLeftLayer;
        ...
        if (mRightLayer instanceof ChartView.IGroupLayer) {
            ChartView.IGroupLayer layer = (ChartView.IGroupLayer) mRightLayer;
            ChartLayer l = layer.getLayerByTag(tag);
            if (l != null) {
                return l;
            }
